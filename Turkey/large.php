...
<div class="clearfix-padding"></div>
	<section>
		<h3 class="items"><a href="product.php" title="Other Items">Other Items</a>Price of Large Size Turkey</h3>
		<br> <br> <br>
		<!-- Database-->
		...
		<table class="price">
			...
			<?php
				...
				$sql = "SELECT item_name, item_price FROM `items` where `item_type` = 'Adult Turkey'";
