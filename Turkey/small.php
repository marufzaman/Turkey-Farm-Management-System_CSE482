...
<div class="clearfix-padding"></div>
	<section>
		<h3 class="items"><a href="product.php" title="Other Items">Other Items<br></a>Price of Turkey Chick</h3>
		<br> <br> <br>
		<!-- Database-->
		...
		<table class="price">
			...
			<?php
				...
				$sql = "SELECT item_name, item_price FROM `items` where `item_type` = 'Turkey Chicks'";
